...
<body>
    ...
    <button type="button" class="btn btn-link toggle-password eye-icon-button" onclick="togglePasswordVisibility('pass1')">
        <i class="fa fa-eye" id="eyeIcon1"></i>
    </button>
</div>

<div class="form-group position-relative">
    <input class="form-control form-control-lg" id="pass2" data-parsley-equalto="#pass1" type="password" required="" placeholder="Confirm password" name="confirm_password">
    <button type="button" class="btn btn-link toggle-password eye-icon-button" onclick="togglePasswordVisibility('pass2')">
...
<script>
    function togglePasswordVisibility(inputId) {
        ...
        var eyeIcon = document.getElementById('eyeIcon' + inputId.slice(-1));
