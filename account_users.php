...
<head>
    ...
    <title>Twa-akka - Account Users</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="container-fluid dashboard-content"> 
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        $select = "SELECT * FROM Twa_akka_users_registrations where users_id = $users_id";
                        $query = mysqli_query($conn, $select);
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            $select = "SELECT * FROM Twa_akka_orders where users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            // $select = "SELECT * FROM Twa_akka_orders_detail";
                                            $select = "SELECT Twa_akka_orders_detail.*, Twa_akka_orders.orders_id FROM Twa_akka_orders_detail JOIN Twa_akka_orders ON Twa_akka_orders_detail.orders_id = Twa_akka_orders.orders_id WHERE users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
