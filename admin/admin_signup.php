...
<head>
    ...
    <title>Twa-akka - Admin Sign Up</title>
    <!-- Bootstrap CSS -->
...
<div class="form-group position-relative">
    <input class="form-control form-control-lg" id="pass2" data-parsley-equalto="#pass1" required="" placeholder="Confirm" name="confirm_password">
    <button type="button" class="btn btn-link toggle-password" onclick="togglePasswordVisibility('pass2')" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none;">
