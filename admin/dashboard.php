...
<head>
    ...
    <title>Twa-akka - Dashboard</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-primary">
                            <div class="card-body">
                                ...
                                <?php
                                $select_users = "SELECT * FROM Twa_akka_users_registrations";
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-brand">
                            <div class="card-body">
                                ...
                                <?php
                                $select_category = "SELECT * FROM Twa_akka_category";
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-secondary">
                            <div class="card-body">
                                ...
                                <?php
                                $select_product = "SELECT * FROM Twa_akka_product";
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card bg-success">
                            <div class="card-body">
                                ...
                                <?php
                                $select_orders = "SELECT * FROM Twa_akka_orders";
