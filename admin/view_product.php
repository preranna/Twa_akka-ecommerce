...
<head>
    ...
    <title>Twa-akka - View Product</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT Twa_akka_product.*, Twa_akka_category.category_name FROM Twa_akka_product JOIN Twa_akka_category ON Twa_akka_product.product_category = Twa_akka_category.category_id";
